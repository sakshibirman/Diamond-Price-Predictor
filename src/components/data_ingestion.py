...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            if not os.path.exists('gemstone.csv'):
                raise FileNotFoundError("The file gemstone.csv was not found in the current directory.")
            logging.info("File gemstone.csv found!")
